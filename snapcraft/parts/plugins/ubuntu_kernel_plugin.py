...
class BuildCommandGenerator:
    ...
    def ubuntu_source_tree(self) -> list[str]:
        ...
        cmds += [
            ...
            f"debian/rules build-{self.options.ubuntu_kernel_flavour}",
            """
...
class UbuntuKernelPlugin(plugins.Plugin):
    ...
    def __init__(
        ...
        self.image_target = (
            ...
            else _DEFAULT_KERNEL_IMAGE_TARGET[part_info.arch_triplet_build_for]
        )
    ...
    def get_build_environment(self) -> dict[str, str]:
        env = {
            ...
            "DEBIAN_KERNEL_IMAGE_TYPE": self.image_target,
        }
        if self.part_info.is_cross_compiling:
    ...
    def get_pull_commands(self) -> list[str]:
        ...
        if self.options.source or not self.release_name:
